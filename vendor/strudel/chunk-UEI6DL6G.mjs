...
// strudel/packages/mini/krill-parser.js
...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(s, stepsPerCycle) {
  ...
  var peg$f7 = function(s) {
    s.arguments_.alignment = "polymeter_slowcat";
    return s;
  };
  ...
  var peg$f17 = function(_steps, s) {
    return new PatternStub(s, "fastcat", void 0, !!_steps);
  };
  ...
  var peg$f32 = function(s, v) {
    return v;
  };
  var peg$f33 = function(s, ss) {
    ss.unshift(s);
  ...
  var PatternStub = function(source, alignment, seed2, _steps) {
    this.type_ = "pattern";
    this.arguments_ = { alignment, _steps };
    if (seed2 !== void 0) {
      this.arguments_.seed = seed2;
    }
    this.source_ = source;
  };
...
// strudel/packages/mini/mini.mjs
var randOffset = 3e-4;
var applyOptions = (parent, enter) => (pat, i) => {
    ...
    for (const op of ops) {
      switch (op.type_) {
        ...
        case "range": {
          ...
          let range = (apat, bpat) => apat.squeezeBind((a) => bpat.bind((b) => fastcat(...arrayRange(a, b))));
      ...
      switch (alignment) {
        ...
        default: {
          ...
          if (weightedChildren) {
            ...
            pat = timeCat(
              ...ast.source_.map((child, i) => [child.options_?.weight || fraction_default(1), children[i]])
            );
